...
salaries2014 <- c(runif(100, 40000, 50000))
print(salaries)
...
salaries2015 <- salaries + runif(100, -10000, 20000)
print(salaries2015)

# Create a data.frame 'salaries' by combining the 3 vectors you just made
# Remember to set `stringsAsFactors=FALSE`!
salaries <- data.frame(employees, salaries2014, salaries2015, stringsAsFactors = FALSE)
...
print(salaries[57, 'salaries2015'])
